...
window_size = 3
min_disp = 2 # Sets the minimum disparity value.
num_disp = 130-min_disp # Calculates the number of disparities based on the minimum disparity.
stereo = cv2.StereoSGBM_create(minDisparity = min_disp, # Semi-Global Block Matching (SGBM) stereo object for dense disparity map computation
    numDisparities = num_disp,
    blockSize = window_size,
    uniquenessRatio = 10,
    # Parameters for filtering out small, isolated noise points in the disparity map.
...
# WLS FILTER Parameters - weighted least square filter
lmbda = 80000
sigma = 1.8
